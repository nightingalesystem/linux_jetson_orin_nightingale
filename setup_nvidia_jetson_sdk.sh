...
export DEVICE_FOLDER='Jetson_Linux_R35.4.1_aarch64'
...
wget "https://developer.download.nvidia.com/embedded/L4T/r35_Release_v4.1/release/Jetson_Linux_R35.4.1_aarch64.tbz2" -P $DOWNLOAD_PATH_SCRIPT
echo -e "\e[7mDownloading the rootfs.\e[0m"

wget "https://developer.download.nvidia.com/embedded/L4T/r35_Release_v4.1/release/Tegra_Linux_Sample-Root-Filesystem_R35.4.1_aarch64.tbz2" -P $DOWNLOAD_PATH_SCRIPT
...
echo -e "\e[7mUntar nvidia bsp: Jetson_Linux_R35.4.1_aarch64.tbz2.\e[0m"

sudo tar -xf $DOWNLOAD_PATH_SCRIPT/Jetson_Linux_R35.4.1_aarch64.tbz2

cd $JETPACK/rootfs
echo -e "\e[7mUntar rootfs Jetson_Linux_R35.4.1_aarch64.tbz2.\e[0m"

sudo tar -xf $DOWNLOAD_PATH_SCRIPT/Tegra_Linux_Sample-Root-Filesystem_R35.4.1_aarch64.tbz2
