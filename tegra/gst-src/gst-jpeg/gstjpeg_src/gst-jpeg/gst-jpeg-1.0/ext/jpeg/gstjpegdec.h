...
typedef struct _GstJpegDec           GstNvJpegDec;
typedef struct _GstJpegDecClass      GstNvJpegDecClass;


#define GstJpegDec GstNvJpegDec
#define GstJpegDecClass GstNvJpegDecClass
...
struct _GstJpegDec {
  ...
  guint    gpu_id;
  gboolean bEnable_rgba_output;
  gboolean bEnable_nv12_output;
  ...
  guint    rem_img_len;
  /* Mark nvmm output format to avoid memcpy */
  gboolean is_nvmm_format;
};
