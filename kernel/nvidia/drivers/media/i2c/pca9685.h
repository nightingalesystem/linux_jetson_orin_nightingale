...
#define ECON_MULTILANE_BASEBOARD_BUS_ADDRESS 36
...
static int pca9685_config(struct i2c_client*,int,int);
...
static struct psc_mode pre_limit[MAX_PWM_MODE] = {
	...
	/* This below exposure time period value setting is for ar0330 sensor */
	//{337,339,0xD0},	// TBD measure and update
	{168,170,0x66}, // 58.82Hz to 59.52Hz
};
...
int pca9685_init(struct i2c_client*);
